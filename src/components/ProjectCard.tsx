          ...
          >
            <div className="relative h-full rounded-2xl bg-secondary/90 backdrop-blur-xl border border-accent/30 shadow-[0_20px_80px_rgba(0,173,181,0.3)] overflow-y-auto">
              ...
              <div className="p-6 md:p-8 lg:p-10">
                ...
                {/* Status Badge */}
                {project.status && (
                  <div className="inline-block px-4 py-1 rounded-full bg-accent/20 border border-accent/30 text-accent text-sm font-semibold mb-6 ml-3">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {project.tags.map((tag) => (
                        <span
                          key={tag}
                          className="px-4 py-2 text-sm rounded-full bg-primary/50 border border-accent/20 text-text-secondary font-medium"
                        >
                          {tag}
                        </span>
                      ))}
